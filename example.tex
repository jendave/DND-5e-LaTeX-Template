...
\renewcommand{\DndCoverImage}{img/example-frontcover}
...
\include{example-part-2.tex}

\backmatter%

\include{example-back.tex}

{\hypersetup{hidelinks}
	\printindex[index]
}

\renewcommand*{\DndBackCoverImage}{img/example-backcover}
...
\renewcommand*{\DndBackCoverLogo}{img/cover-logo}
\DndMakeBackCover%
